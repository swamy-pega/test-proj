...
const Navbar = () => {
  return (
    <nav style={{ width:"100%", margin: "1 auto", padding: "5px" ,display:"inline-flex" }}>
      ...
      {/* <div style={{padding:"10px"} }><Link style={{ color: "lightblue"}} to="/services">Heremap</Link>  </div>
      ...
      <div style={{padding:"10px"} }><Link style={{ color: "lightblue"}} to="/schedule-appt">Schedule Appointment </Link> </div>
