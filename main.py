...
origins = [
    ...
    "http://www.swamy-p.xyz", "https://www.swamy-p.xyz","https://pythonproj-swamy-6ac538a29b8b.herokuapp.com"
...
app.mount("/quiz-app", StaticFiles(directory="./myquiz-app-backup/dist", html=True), name="quiz-app")
